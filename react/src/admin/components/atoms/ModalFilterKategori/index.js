...
function ModalFilterKategori({ onClickShowModal, onClickCancel, filterBy, setFilterBy, searchFilter, setSearchFilter, statusFilter, setStatusFilter, startDate, setStartDate, endDate, setEndDate, resetFilter, submitFilter, showDateFilter = false, showStatusFilter = false, showSearchFilter = false, showName = false, showKategori = false }) {
                    ...
                    <Row>
                        <Col xs={3} md={6} lg={6} style={{ paddingRight: 6 }}>
                            <Dropdown
                                ...
                                {showKategori && (
                                    <option value="kategori" selected={filterBy === "kategori"}>Kategori</option>
                                )}
                            </Dropdown>
                        </Col>
