...
function ModalFilterVendor({ onClickShowModal, onClickCancel, filterBy, setFilterBy, searchFilter, setSearchFilter, statusFilter, setStatusFilter, startDate, setStartDate, endDate, setEndDate, resetFilter, submitFilter, showDateFilter = false, showStatusFilter = false, showSearchFilter = false, showName = false, showVendor = false }) {
                    ...
                    <Row>
                        <Col xs={3} md={6} lg={6} style={{ paddingRight: 6 }}>
                            <Dropdown
                                ...
                                {showName && (
                                    <option value="nama_vendor" selected={filterBy === "nama_vendor"}>Nama Vendor</option>
                                )}
                                {showVendor && (                                    
                                    <option value="nomor_telp" selected={filterBy === "nomor_telp"}>Nomor Telepon</option>
                                )}
                            </Dropdown>
                        </Col>
...
export default  ModalFilterVendor;